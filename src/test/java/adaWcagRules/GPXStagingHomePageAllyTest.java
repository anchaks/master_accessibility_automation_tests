...
public class GPXStagingHomePageAllyTest 
{
    // WebDriver instance to control the browser
    private WebDriver driver;

    // URL of the website to be tested
    private static final String URL = "https://development.gpx.com/";

    // File to store the accessibility test results in JSON format
    private static final File JSON_RESULTS = new File("GPXStagingHomePage-wcag22-results.json");
    ...
    public void testAccessibility() throws Exception {
        ...
        String fileName = "GPXStagingHomePage-wcag22-violations-" + timeStamp + ".xlsx";
