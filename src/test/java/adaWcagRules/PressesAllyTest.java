...
public class PressesAllyTest 
{
    // WebDriver instance to control the browser
    private WebDriver driver;

    // URL of the website to be tested
    private static final String URL = "https://presses.com/";

    // File to store the accessibility test results in JSON format
    private static final File JSON_RESULTS = new File("Presses-wcag22-results.json");
    ...
    public void testAccessibility() throws Exception {
        ...
        String fileName = "Presses-wcag22-violations-" + timeStamp + ".xlsx";
