...
public class arngrennetallytest 
{
...
// WebDriver instance to control the browser
    ...
    private static final String URL = "https://arngren.net/";

    // File to store the accessibility test results in JSON format
    private static final File JSON_RESULTS = new File("arngrennet-wcag22-results.json");
    ...
    public void testAccessibility() throws Exception {
        ...
        String fileName = "arngrennet-wcag22-violations-" + timeStamp + ".xlsx";
